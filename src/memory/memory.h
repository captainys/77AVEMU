...
public:
	...
	virtual uint8_t FetchByte(const CanAccessMemory *accessFrom,uint16_t addr)=0;
	virtual uint16_t FetchWord(const CanAccessMemory *accessFrom,uint16_t addr)=0;
	virtual void StoreByte(const CanAccessMemory *accessFrom,uint16_t addr,uint8_t data)=0;
	virtual void StoreWord(const CanAccessMemory *accessFrom,uint16_t addr,uint16_t data)=0;
