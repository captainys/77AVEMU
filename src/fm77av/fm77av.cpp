...
FM77AV::CRTC::CRTC(VMBase *vmBase) : Device(vmBase)
{
}
FM77AV::Palette &FM77AV::CRTC::GetPalette(void)
{
	return state.palette;
}
const FM77AV::Palette &FM77AV::CRTC::GetPalette(void) const
{
	return state.palette;
}
...
bool FM77AV::CRTC::InVSYNC(const uint64_t fm77avTime) const
{
	unsigned int intoFrame=((unsigned long long)fm77avTime)%VSYNC_CYCLE;
	return  (CRT_VERTICAL_DURATION<intoFrame);
}
bool FM77AV::CRTC::InHSYNC(const uint64_t fm77avTime) const
{
	unsigned int intoFrame=((unsigned long long)fm77avTime)%VSYNC_CYCLE;
...
uint64_t FM77AV::CRTC::NextVSYNCRisingEdge(uint64_t fm77avTime) const
{
...
uint64_t FM77AV::CRTC::NextVSYNCEndTime(uint64_t fm77avTime) const
{
	uint64_t mod=fm77avTime%VSYNC_CYCLE;
